...
export function Constellation({ citations }: { citations: Citation[] }) {
  ...
  return (
    <div className="relative z-10 mt-3 w-full max-w-md">
      <p className="mb-2 text-center font-mono text-[9px] uppercase tracking-[0.28em] text-sea/70">
        evidence
      </p>
      ...
      {open ? (
        <div className="absolute left-1/2 top-full z-20 mt-3 w-[min(420px,90vw)] -translate-x-1/2 rounded-2xl border border-gold/20 bg-[#1A1A2E]/95 p-4 shadow-2xl backdrop-blur-md">
